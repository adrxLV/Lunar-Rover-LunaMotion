...
void SoftPWMSetPercent(int8_t pin, float percent, uint8_t hardset)
{
  SoftPWMSet(pin, ((float)percent * 255) / 100, hardset);
}


void SoftPWMSet(int8_t pin, float value, uint8_t hardset)
{
